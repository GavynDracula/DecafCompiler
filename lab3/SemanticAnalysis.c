...
ExprType* GetExprType(GrammarTree tree, ScopeStack* stack)
{
    ...
    else if (!strcmp(tree->name, "KEYNEW") && !strcmp(tree->rchild->name, "IDENTIFIER"))
    {
        ...
        if (!globalscope)
        {
            ...
            smerror += 1;
            printf("Semantic Error at Line %d Column %d: The Class \"%s\" is not Declared!\n", 
...
void SameNameTrial(ClassScope classscope, GrammarTree tree)
{
    ...
    while (classscope)
    {
        ...
        while (tmp != classscope)
        {
            ...
            {
                smerror += 1;
                printf("Semantic Error at Line %d Column %d: There are Members whose Name are all \"%s\" in Class \"%s\"!\n", 
...
void ScopeTrial(GrammarTree tree, Scope scope, ScopeStack* stack)
{
    ...
    else if (!strcmp(tree->name, "ClassDef"))
    {
        ...
        {
            smerror += 1;
            printf("Semantic Error at Line %d Column %d: The Class \"%s\" has been Declared!\n", 
        ...
        if (classdsp->parentname)
        {
            ...
            {
                smerror += 1;
                printf("Semantic Error at Line %d Column %d: The Parent Class \"%s\" is Not Declared!\n", 
    ...
    else if (!strcmp(tree->name, "LValue") && !strcmp(tree->lchild->name, "IDENTIFIER"))
    {
        ...
        {
            smerror += 1;
            printf("Semantic Error at Line %d Column %d: The Variable \"%s\" is Not Declared Before Used!\n", tree->line, tree->column, tree->lchild->string_value);
        }
        else if (result.type == ScopeGlobal)
        {
            smerror += 1;
            printf("Semantic Error at Line %d Column %d: The Class \"%s\" can Not be Used as Left Value!\n", tree->line, tree->column, tree->lchild->string_value);
        }
        else if (tree->rchild && !strcmp(tree->rchild->name, "OPASSIGN"))
        {
            ...
            if (exprtype)
            {
                ...
                {
                    smerror += 1;
                    printf("Semantic Error at Line %d Column %d: The Two Sides of \"=\" have Conflicted Types! One is \"%s\", but the Other is \"%s\"!\n", 
    ...
    else if (!strcmp(tree->name, "LValue") && !strcmp(tree->lchild->name, "Expr") && !strcmp(tree->lchild->rchild->name, "SPDOT"))
    {
        ...
        if (type)
        {
            ...
            if (!strncmp(type->type, "class:", 6))
            {
                ...
                {
                    smerror += 1;
                    printf("Semantic Error at Line %d Column %d: Class \"%s\" has No Attribute Called \"%s\"!\n", 
            ...
            {
                smerror += 1;
                printf("Semantic Error at Line %d Column %d: It is Not an Instance of Any Class!\n", tree->lchild->line, tree->lchild->column);
            }
        }
    }
    else if (!strcmp(tree->name, "Call") && !strcmp(tree->lchild->name, "IDENTIFIER"))
    {
        ...
        {
            smerror += 1;
            printf("Semantic Error at Line %d Column %d: The Function \"%s\" is Not Declared Before Used!\n", tree->line, tree->column, tree->lchild->string_value);
        }
    ...
    else if (!strcmp(tree->name, "Call") && !strcmp(tree->lchild->name, "Expr") && !strcmp(tree->lchild->rchild->name, "SPDOT"))
    {
        ...
        if (type)
        {
            if (!strncmp(type->type, "class:", 6))
            {
                ...
                {
                    smerror += 1;
                    printf("Semantic Error at Line %d Column %d: Class \"%s\" has No Method Called \"%s\"!\n", 
                           tree->lchild->line, tree->lchild->column, type->type + 6, tree->lchild->rchild->rchild->string_value);
                }
            }
            else
